/**
 * Frame Processor — utilities for frame preprocessing and config
 */
...
/**
 * Base thresholds per sensitivity. Detector further calibrates these against
 * per-video noise floor during a warmup pass.
 */
